...
public class SpringBootExampleWicketApplication extends WebApplication {
    ...
    public static void main(String[] args) {
        SpringApplication.run(SpringBootExampleWicketApplication.class, args);
    }
    ...
    protected void init() {
        getRequestCycleListeners().add(new AbstractRequestCycleListener() {
            ...
            public IRequestHandler onException(final RequestCycle cycle, final Exception ex) {
                final ConstraintViolationException cause = Exceptions.findCause(ex, ConstraintViolationException.class);
                if (Objects.nonNull(cause)) {
                    final IPageRequestHandler handler = cycle.find(IPageRequestHandler.class);
